...
object
    ...
    method changeIndex : index -> occupied -> unit
    ...
    method addBlackNeighbors : index -> index -> unit

    method addWhiteNeighbors : index -> index -> unit  
    
    method addMultBlackNeighbors : index -> index -> index -> unit  

    method addMultWhiteNeighbors : index -> index -> index -> unit 
